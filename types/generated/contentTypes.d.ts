...
export interface ApiHomepageHomepage extends Schema.SingleType {
  ...
  attributes: {
    aboutContent: Attribute.RichText & Attribute.Required;
    ...
    servicesContent: Attribute.RichText & Attribute.Required;
...
export interface ApiLeadLead extends Schema.CollectionType {
  ...
  info: {
    description: 'Prospects who completed and submitted the contact form';
    displayName: 'Lead';
    pluralName: 'leads';
    singularName: 'lead';
  };
  ...
  attributes: {
    convertedToUser: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    ...
    lastContactedAt: Attribute.DateTime;
    lastName: Attribute.String &
      Attribute.Required &
      Attribute.SetMinMaxLength<{
        maxLength: 50;
    ...
    prospect: Attribute.Relation<
      'api::lead.lead',
      'oneToOne',
      'api::prospect.prospect'
    >;
    status: Attribute.Enumeration<
      ['nuevo', 'contactado', 'en-negociacion', 'convertido', 'perdido']
    > &
      Attribute.DefaultTo<'nuevo'>;
    submittedAt: Attribute.DateTime & Attribute.Required;
    trainingGoal: Attribute.Enumeration<
      [
        'perdida-peso',
...
export interface ApiPricingPricing extends Schema.SingleType {
  ...
  info: {
    description: 'Pricing information management';
    displayName: 'Pricing';
    pluralName: 'pricings';
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    plans: Attribute.JSON & Attribute.Required;
    publishedAt: Attribute.DateTime;
...
export interface ApiProspectProspect extends Schema.CollectionType {
  collectionName: 'prospects';
  info: {
    description: "Potential customers who showed interest but haven't submitted the form yet";
  ...
  attributes: {
    capturedAt: Attribute.DateTime & Attribute.Required;
    convertedToLead: Attribute.Boolean & Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::prospect.prospect',
      'oneToOne',
...
export interface ApiSellerSeller extends Schema.CollectionType {
  ...
  info: {
    description: 'Sales representatives who manage leads and customers';
    displayName: 'Seller';
    pluralName: 'sellers';
    singularName: 'seller';
  };
...
export interface ApiUserUser extends Schema.CollectionType {
  collectionName: 'users_customers';
  info: {
    description: 'Converted leads who became paying customers';
  ...
  attributes: {
    ...
    lead: Attribute.Relation<'api::user.user', 'oneToOne', 'api::lead.lead'>;
    medicalNotes: Attribute.Text;
    membershipStatus: Attribute.Enumeration<
      ['activo', 'pausado', 'cancelado', 'vencido']
    > &
